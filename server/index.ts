...
app.get("/api/health", (c) => c.json({ ok: true, service: "incidentdesk" }));
app.route("/api/incidents", incidentsRoute);
...
console.log(`IncidentDesk listening on http://localhost:${port}`);
